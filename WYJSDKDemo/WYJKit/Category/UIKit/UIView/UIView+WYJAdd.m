...
- (void)yi_roundeConrnersWithFrame:(CGRect)frame rectCorner:(UIRectCorner)rectCon radii:(CGFloat)radii {
    UIBezierPath* rounded = [UIBezierPath bezierPathWithRoundedRect:frame byRoundingCorners:rectCon cornerRadii:CGSizeMake(radii, radii)];
...
- (void)yi_addBorderToWithFrame:(CGRect)frane side:(UIRectEdge)side color:(UIColor *)color lineWidth:(CGFloat)lineWidth {
    ...
    CGFloat width = CGRectGetWidth(frane);
    CGFloat height = CGRectGetHeight(frane);
